...
public abstract class Animal {
    ...
    public static void main(String[] args) {
       // Animal animal=new Animal() ;  animal class is abstract, we cannot create an object for abstract class. should be created in a concrete class which has no abstract
        //  animal.eat();
