...
public class PrintMapForEachRow {
    public static void main(String[] args) throws IOException {
        ...
        // the Map that will store the data for each row.We should use linkedHashMap because we need to keep the order of the data

        // A loop that goes through all the rows that contain the data.
        for (int rowNo = 1; rowNo < noOfRow; rowNo++) {
            LinkedHashMap<String, String> rowMap = new LinkedHashMap<>(); // better to put it inside the loop
